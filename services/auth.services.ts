...
export const fetchUserInfoApi = async () => {
  ...
  return await apiFetch(`/api/user/get-user-info`, {
    cache: "no-store",
    method: "GET",
    credentials: "include",
  });
...
export const fetchWorkspaceMembersApi = async (workspaceId: string) => {
  ...
  return await apiFetch(`/api/workspace/${workspaceId}/members`, {
    cache: "no-store",
    method: "GET",
    credentials: "include",
  });
...
export const getWorkspaceApi = async () => {
  ...
  return await apiFetch(`/api/workspace/currentActiveWorkspace`, {
    cache: "no-store",
    method: "GET",
    credentials: "include",
  });
...
export const updateWorkspaceApi = async (formData: FormData) => {
  ...
  const res = await apiFetch(`/api/workspace/update-workspace`, {
    method: "PUT",
    credentials: "include",
    body: formData,
  });
...
export const fetchAnalyticsApi = async () => {
  ...
  return await apiFetch(`/api/workspace/workspaceAnalyticsData`, {
    cache: "no-store",
    method: "GET",
    credentials: "include",
  });
...
export const deleteWorkspaceApi = async () => {
  ...
  const res = await apiFetch(`/api/workspace/delete-workspace`, {
    method: "DELETE",
    credentials: "include",
  });
...
export const createWorkspaceApi = async (name: string) => {
  ...
  const res = await apiFetch(`/api/workspace/create-workspace`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    credentials: "include",
...
export const createInvitationApi = async (email: string, role: string) => {
  ...
  return await apiFetch(`/api/workspace/invitation`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    credentials: "include",
...
export const acceptInvitationApi = async (token: string) => {
  ...
  return await apiFetch(`/api/workspace/invitation/accept`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    credentials: "include",
...
export const validateInvitationApi = async (token: string) => {
  return await apiFetch(
    ...
    `/api/workspace/invitation/accept?token=${encodeURIComponent(token)}`,
...
export const fetchPendingInvitationsApi = async () => {
  ...
  return await apiFetch(`/api/workspace/invitation/pending`, {
    cache: "no-store",
    method: "GET",
    credentials: "include",
  });
...
export const fetchUserPendingInvitationsApi = async () => {
  ...
  return await apiFetch(`/api/user/pending-invitations`, {
    cache: "no-store",
    method: "GET",
    credentials: "include",
  });
...
export const fetchReceivedInvitationApi = async (invitationId: string) => {
  ...
  return await apiFetch(`/api/user/pending-invitations/${invitationId}`, {
    cache: "no-store",
    method: "GET",
    credentials: "include",
  });
...
export const leaveWorkspaceApi = async (workspaceId: string) => {
  ...
  return apiFetch(`/api/workspace/leave-workspace`, {
    method: "DELETE",
    headers: {
