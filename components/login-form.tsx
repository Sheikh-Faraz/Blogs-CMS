...
function LoginFormContent({
  ...
  return (
    ...
    <div 
      className="mx-auto flex w-full max-w-5xl flex-col gap-5 px-4 sm:px-6 lg:flex-row-reverse lg:items-start lg:justify-center"
    >
    ...
    {/* {isInvitationFlow && (
      ...
      <div className="flex flex-col items-center gap-2 text-center m-4">
