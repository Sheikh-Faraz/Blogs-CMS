...
function InvitationSkeleton() {
  return (
    <div className="mx-auto flex min-h-[70vh] w-full max-w-xl items-center px-4 py-6 sm:px-6">
      <div className="w-full rounded-2xl border bg-card p-4 text-card-foreground shadow-sm sm:p-6">

        {/* Back to invitations */}
        <div className="mb-6 flex w-fit items-center gap-2 py-2 sm:mb-8">
        ...
        <div className="flex gap-3 sm:gap-5">
          ...
          {/* Workspace icon */}
          <div className="flex h-12 w-12 shrink-0 animate-pulse items-center justify-center rounded-xl bg-muted sm:h-14 sm:w-14" />
          ...
          <div className="min-w-0 space-y-2">
            ...
            {/* Workspace name */}
            <div className="mt-1 h-7 w-52 max-w-full animate-pulse rounded bg-muted" />
          </div>
        ...
        {/* Expiration */}
        <div className="mt-6 h-3 w-52 max-w-full animate-pulse rounded bg-muted sm:mt-8" />
...
export default function InvitationDetailsPage() {
  ...
  useEffect(() => {
    ...
    const fetchInvitation = async () => {
      try {
        ...
        if (!res.ok) {
          throw new Error(
            data.message || "Failed to fetch invitation"
          );
        }
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      toast.success(
        "Invitation accepted successfully, you can now access the workspace through the workspace list in the sidebar."
      );
  ...
  if (error || !invitation) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center px-4 py-6 sm:p-6">
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] w-full max-w-xl items-center px-4 py-6 sm:px-6">
      ...
      <div className="w-full rounded-2xl border bg-card p-4 text-card-foreground shadow-sm sm:p-6">
        ...
        <Link
          href="/invitations"
          className="mb-6 flex w-fit items-center gap-2 py-2 text-sm hover:text-gray-300 sm:mb-8"
        >
          <CircleArrowLeft className="h-5 w-5 shrink-0 text-[#E85129]" />
        ...
        <div className="flex items-start gap-3 sm:gap-5">
          ...
          {/* Workspace icon */}
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border bg-muted text-lg font-semibold sm:h-14 sm:w-14 sm:text-xl">
          ...
          <div className="min-w-0">
            ...
            <h1 className="mt-1 wrap-break-word text-xl font-semibold sm:text-2xl">
              {invitation.workspace?.name ||
                "Unknown Workspace"}
            </h1>
          </div>
        ...
        <div className="mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row">
          ...
          <button
            ...
            className="flex-1 rounded-lg border bg-card px-4 py-2 text-sm disabled:opacity-50 hover:bg-muted"
          >
            {accepting
              ? <LoaderIcon />
              : "Accept invitation"}
...
//   return (
//     // <div className="mx-auto flex min-h-[70vh] w-xl items-center p-6 ">
//     <div className="mx-auto flex min-h-[70vh] w-xl items-center p-6 border border-red-600">
