...
<!-- -- For EDITOR role the delete button should be disable and the tooltip should tell that        -- DONE -->
<!--    not allowed with this role  -->
<!-- -- For vIEWER role disable the edit and delete button while showing tooltip correct            -- DONE -->
<!--    message for it  -->

<!-- -- ALSO NOTE IF THE USER TRIES TO OPEN THE EDIT PAGE WILL HIS ROLE IS VIEWER THEN              -- DONE -->
<!--    WE SHOULD SHOW SOMETHING TO TELL THEM  -->

<!-- --  Displaying message for persmissoin not allowed but when loading it shows for               -- DONE  -->
<!--     other roles so fix that -->
...
<!-- -- For VIEWER role it is correctly giving message not allowed, showing message                 -- DONE -->
